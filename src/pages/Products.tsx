    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h1 className="text-3xl md:text-5xl font-bold text-foreground mb-2">Our Collection</h1>
            <p className="text-muted-foreground mb-8">Everything you need for a spectacular event.</p>
          </motion.div>
